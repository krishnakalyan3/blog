---
title: "Introduction to Spark UI"
date: "2020-11-12"
...
## Environment
To prepare our environment let install 
- `Python 3.9`
- `Java 11 Zulu`
...
Congratulations, You now have Master UI on `localhost:8080`. Let's submit a test job to make sure everything works well.
